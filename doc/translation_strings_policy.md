...
This document provides guidelines for internationalization of the GlobalBitcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `globalbitcoin_en.ts` remains unchanged.
