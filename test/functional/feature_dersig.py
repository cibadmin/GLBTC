...
class BIP66Test(GlobalBitcoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # globalbitcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and globalbitcoind produces more specific reject
            # reasons.
