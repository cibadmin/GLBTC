...
# TestP2PConn: A peer we use to send messages to globalbitcoind, and store responses.
...
class CompactBlocksTest(GlobalBitcoinTestFramework):
    ...
    # This test actually causes globalbitcoind to (reasonably!) disconnect us, so do this last.
    ...
    # globalbitcoind's choice of nonce.
    ...
    # Test that globalbitcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for globalbitcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # globalbitcoind will not send blocktxn responses for blocks whose height is
