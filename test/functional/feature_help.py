...
"""Verify that starting globalbitcoin with -h works as expected."""

from test_framework.test_framework import GlobalBitcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(GlobalBitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start globalbitcoin with -h for help text")
        ...
        self.log.info("Start globalbitcoin with -version for version information")
        ...
        self.log.info("Start globalbitcoind with -fakearg to make sure it does not start")
