/* src/config/globalbitcoin-config.h.  Generated from globalbitcoin-config.h.in by configure.  */
/* src/config/globalbitcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef GLOBALBITCOIN_CONFIG_H

#define GLOBALBITCOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The GlobalBitcoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "GlobalBitcoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/globalbitcoin/globalbitcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "GlobalBitcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "GlobalBitcoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "globalbitcoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://globalbitcoincore.org/"
