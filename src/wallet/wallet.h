...
#ifndef GLOBALBITCOIN_WALLET_WALLET_H
#define GLOBALBITCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this globalbitcoin node, and set to 0 for transactions that were created
...
#endif // GLOBALBITCOIN_WALLET_WALLET_H
