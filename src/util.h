 ...
 */
#ifndef GLOBALBITCOIN_UTIL_H
#define GLOBALBITCOIN_UTIL_H
...
extern const char * const GLOBALBITCOIN_CONF_FILENAME;
extern const char * const GLOBALBITCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("globalbitcoin-%s", name);
