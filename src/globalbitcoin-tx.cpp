...
static void SetupGlobalBitcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " globalbitcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  globalbitcoin-tx [options] <hex-tx> [commands]  Update hex-encoded globalbitcoin transaction\n" +
            "or:     globalbitcoin-tx [options] -create [commands]   Create hex-encoded globalbitcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded globalbitcoin transaction
