...
#ifndef GLOBALBITCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define GLOBALBITCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // GLOBALBITCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
