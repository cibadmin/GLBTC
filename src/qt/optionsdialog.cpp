    ...
    mapper(0)
{
    ...
    ui->globalbitcoinAtStartup->setToolTip(ui->globalbitcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->globalbitcoinAtStartup->setText(ui->globalbitcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openGlobalBitcoinConfButton->setToolTip(ui->openGlobalBitcoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new GlobalBitcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->globalbitcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openGlobalBitcoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openGlobalBitcoinConf())
