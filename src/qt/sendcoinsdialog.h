...
#ifndef GLOBALBITCOIN_QT_SENDCOINSDIALOG_H
#define GLOBALBITCOIN_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending globalbitcoins */
...
#endif // GLOBALBITCOIN_QT_SENDCOINSDIALOG_H
