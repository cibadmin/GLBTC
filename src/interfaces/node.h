...
#ifndef GLOBALBITCOIN_INTERFACES_NODE_H
#define GLOBALBITCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a globalbitcoin node (globalbitcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // GLOBALBITCOIN_INTERFACES_NODE_H
