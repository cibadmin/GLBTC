...
#ifndef GLOBALBITCOIN_TEST_SCRIPTNUM10_H
#define GLOBALBITCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from GlobalBitcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // GLOBALBITCOIN_TEST_BIGNUM_H
