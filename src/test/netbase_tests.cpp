...
{
    BOOST_CHECK(TestSplitHost("www.globalbitcoincore.org", "www.globalbitcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.globalbitcoincore.org]", "www.globalbitcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.globalbitcoincore.org:80", "www.globalbitcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.globalbitcoincore.org]:80", "www.globalbitcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:16538", "127.0.0.1", 16538));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:16538", "127.0.0.1", 16538));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:16538", "::ffff:127.0.0.1", 16538));
    BOOST_CHECK(TestSplitHost("[::]:16538", "::", 16538));
    BOOST_CHECK(TestSplitHost("::16538", "::16538", -1));
    BOOST_CHECK(TestSplitHost(":16538", "", 16538));
    BOOST_CHECK(TestSplitHost("[]:16538", "", 16538));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:16538", "127.0.0.1:16538"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:16538", "[::]:16538"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
